...
namespace TerraFirmaLike.TweakedFromVanilla
{
    public class FixedStairs : BlockStairs
    {
        ...
        {
            string type = world.BlockAccessor.GetBlock(pos).FirstCodePart(2);
            string material = world.BlockAccessor.GetBlock(pos).FirstCodePart(3);
            if (type == null || material == null)
            {
                return new ItemStack(world.BlockAccessor.GetBlock(0));
            }
            return new ItemStack(world.BlockAccessor.GetBlock(new AssetLocation("stair-side-" + type + "-" + material + "-up-north")));
        }
        ...
        public override ItemStack[] GetDrops(IWorldAccessor world, BlockPos pos, IPlayer byPlayer, float dropQuantityMultiplier = 1f)
        {
            ...
            if (type == null || material == null)
            {
                return new ItemStack[] { new ItemStack(world.BlockAccessor.GetBlock(0)) };
            }
            return new ItemStack[] { new ItemStack(world.BlockAccessor.GetBlock(new AssetLocation("stair-side-" + type + "-" + material + "-up-north"))) };
        }
        ...
        public void StairsCheck(IWorldAccessor world, BlockPos pos, AssetLocation[] cardinal)
        {
            ...
            Block thisBlock = bA.GetBlock(pos);
            string type = thisBlock.FirstCodePart(2);
            string material = thisBlock.FirstCodePart(3);
        ...
        public void CornersCheck(IWorldAccessor world, BlockPos pos, AssetLocation[] cardinal)
        {
            ...
            string type = thisBlock.FirstCodePart(2);
            string material = thisBlock.FirstCodePart(3);
            string updown = thisBlock.LastCodePart(1);
            ...
            if (thisBlock.LastCodePart() == "northeast")
            {
                if (cardinalN == "north")
                {
            ...
            else if (thisBlock.LastCodePart() == "southwest")
            {
                if (cardinalS == "south")
                {
            ...
            else if (thisBlock.LastCodePart() == "southeast")
            {
                if (cardinalN == "south")
                {
                    bA.SetBlock(south.BlockId, pos);
            ...
            else if (thisBlock.LastCodePart() == "northwest")
            {
                if (cardinalW == "west")
                {
                    bA.SetBlock(west.BlockId, pos);
